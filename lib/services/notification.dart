...
final FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin = FlutterLocalNotificationsPlugin();
 ...
 Future<void> init ()async{
   try{
    ...
    const AndroidInitializationSettings androidInitialization = AndroidInitializationSettings('@mipmap/ic_launcher'); // Default Icon
...
Future<void> showNotification({
    ...
    const NotificationDetails platfromDetails = NotificationDetails(
